...
async function main() {
  console.log("🚀 Starting Simple Ethereum Escrow Test...");
  ...
  // Deploy EscrowSrc directly
  const EscrowSrc = await ethers.getContractFactory("EscrowSrc");
  const escrowContract = await EscrowSrc.deploy();
  await escrowContract.waitForDeployment();
  console.log("✅ EscrowSrc deployed at:", await escrowContract.getAddress());
  ...
  await mockToken.connect(maker).approve(await escrowContract.getAddress(), escrowAmount);
